          ...
          <details open={expandedId === recipe.itemId} onToggle={(event) => setExpandedId(event.currentTarget.open ? recipe.itemId : expandedId === recipe.itemId ? "" : expandedId)}>
            ...
            <div className="recipeBody">
              ...
              {talisman && <section className="recipeAcquisition" aria-label="Tılsım reçetesi edinim bilgisi">
                ...
                <p>{talismanRecipeAcquisitionStats.recipeCount} reçetede {talismanRecipeAcquisitionStats.exactRecipeCount} kesin kaynak · {talismanRecipeAcquisitionStats.ambiguousRecipeCount} reçeteyi etkileyen {talismanRecipeAcquisitionStats.ambiguousClaims} ad-çakışmalı iddia · {talismanRecipeAcquisitionStats.withoutAcquisitionCount} reçetede edinim satırı yok. Toplam {talismanRecipeAcquisitionStats.withoutExactSourceCount} reçetenin kesin kaynağı bilinmiyor. Normal İKV verisi KÖ’ye otomatik taşınmaz.</p>
              </section>}
