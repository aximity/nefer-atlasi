...
export const quests: Quest[] = [
  ...
  { id:"fotografci", title:"Fotoğrafçı", level:23, giver:"Arzuhalci", location:"Çınaraltı", region:"Labirent", objective:"Labirent girişine yakın Ruh Taşı'nı bul ve Arzuhalci'ye dön.", dependsOn:["arzuhalciden-jest"], track:"Arzuhalci", recommended:true },
  { id:"kitabe", title:"Kitabe", level:27, giver:"Arzuhalci", location:"Çınaraltı", region:"Labirent", objective:"Labirent'teki Kitabe'nin kopyasını çıkar ve Arzuhalci'ye dön.", dependsOn:["fotografci"], track:"Arzuhalci", recommended:true },
  { id:"philotheosun-salonu", title:"Philotheos'un Salonu", level:28, giver:"Arzuhalci", location:"Çınaraltı", region:"Labirent", objective:"Philotheos'un salonunu bul.", dependsOn:["kitabe"], track:"Arzuhalci", recommended:true },
  { id:"tilsim-gorevi", title:"Tılsım", level:30, giver:"Arzuhalci", location:"Çınaraltı", region:"Labirent", objective:"Philotheos'u öldür ve Arzuhalci'ye dön.", dependsOn:["philotheosun-salonu"], track:"Arzuhalci", recommended:true },
  { id:"akil-oyunlari", title:"Akıl Oyunları", level:30, giver:"Arzuhalci", location:"Çınaraltı", region:"Eminönü", objective:"Işık Hanım ile konuş.", dependsOn:["tilsim-gorevi"], track:"Arzuhalci", reward:{Savaşçı:"Islık Çalan",Büyücü:"Anka",Şifacı:"İnat Kıran"} },
