...
export function questsForLevel(quests, value) {
  ...
  return quests.filter((quest) => quest.minLevel === null || quest.minLevel <= level);
}
...
export function questAvailability(quest, value, completedQuestIds = []) {
  ...
  if (quest.minLevel !== null && quest.minLevel > level) return "level_locked";
...
export const questLocationLabel = (quest) =>
  quest?.location || "Görevi verenin konumu doğrulanıyor";
