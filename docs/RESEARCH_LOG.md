...
- Kaynak denetimi: İlk birleşimde kaynaksız görünen 131 girdinin 106'sı önceki kademe tılsımdı. Bunların 53 üretilebilir II. kademe kaydı sınıf, renk, kademe ve kendi reçetesine bağlandı. Mevcut Gönül kaydı/oyuncu bildirimiyle adı ve rengi eşleşen 10 benzersiz I. kademe girdisi hazır edinim olarak bağlandı ve görsel doğrulama kuyruğuna taşındı; reçete uydurulmadı. KÖ edinme yolu henüz eşleşmeyen 43 I. kademe tılsım ile 25 temel malzeme açık kaldı; toplam açık kaynak sayısı 68'dir.
